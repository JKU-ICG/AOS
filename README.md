...
- 07/28/2022: **Inverse Airborne Optical Sectioning** -- through-foilage tracking with a single, conventonal, hovering (stationary) drone. See [publications](#publications) (Inverse Airborne Optical Sectioning)  
...
### DJI Support
We have developed a [ DJI compatible app](AOS%20for%20DJI/README.md) that integrates AOS to support blue light organisations and others in testing and evaluating airborne optical sectioning for their use cases. Tested DJI drones: Mavic 2 Enterprise Advanced, Mavic Mini, Mini 2 
