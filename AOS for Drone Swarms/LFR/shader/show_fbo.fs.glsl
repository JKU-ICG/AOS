...
uniform bool useCM; // use color map
uniform ivec3 rgbCM; // gnuplot formula
...
{         
    ...
    if(useCM) FragColor = colormap(color.r, rgbCM.r, rgbCM.g, rgbCM.b); //gnuplot e.g. rgbformulae(7, 5, 15)	

}


// from https://github.com/kbinani/colormap-shaders/blob/master/shaders/glsl/gnuplot.frag
