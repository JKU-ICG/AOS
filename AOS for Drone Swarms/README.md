...
Our mobile server equipment can drive 10 platforms in real-time (downstreaming of video- and telemetry-data, as well as upstreaming of waypoint- and control-data). The Bosch power generator ensures power supply in the field for approximatly XXh.  
