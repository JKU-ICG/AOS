...
Our mobile server equipment can drive 10 platforms in real-time (downstreaming of video- and telemetry-data, as well as upstreaming of waypoint- and control-data). It consists of a high end PC (with a 5.8GHz Intel i9-13900KF processor (24 cores), a 24GB Nvidia Geforce RTX 4090 OC GPU, and 64GB RAM), a 16x Gigabit switch for fast internal data transmission between remote controllers, PC, and a router. The router hoops up to 5G connection for external networked RTK data transmission. The Bosch power 1500 profi battery ensures power supply in the field for approximatly 10 hours.  
