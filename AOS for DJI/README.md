...
<br />
[**Get AOS for DJI v3_0**](https://docs.google.com/forms/d/e/1FAIpQLSezKIkoUEhyVqxQAE0MTDYjzC7NbBXMe_QSQlt1ecBU4OQASA/viewform?vc=0&c=0&w=1&flr=0)<br /><br />
...
- **shutter** (top-side, right): Turns on/off anomaly detection (RX). <!-- - **O** (front, right): Options (different settings for RGB and thermal imaging) -->
...
- **pause**: In parameter mode, toggle between chainging contrast of the integral image or RX threshold.
