...
- **Better control**: No soft-buttons or -sliders to be operated in the touch-screen are used anymore. Instead, all functionality of the app is mapped to hard-buttons and sticks. This allows more robust control and supports first-person-view (FVP) flying by attaching googles to the HDMI port of the smart controller.  
