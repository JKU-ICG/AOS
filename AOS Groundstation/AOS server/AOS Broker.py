...
def handle_drone_controls(drone_id, controls):
    ...
    print(f"Arranging drone and camera view : Drone {drone_id}, Heading {current_heading}, Gimbal Pitch {current_gimbal_pitch}, Gimbal Yaw {current_gimbal_yaw}")
...
def publisher_thread(broker, port, topic, username, password):
    ...
    print(f"Connected drones to server: {connected_drones}")       
...
print("Data streaming started to AOS map visualization")
...
server_thread.start()
print('AOS waypoint planning server started')
