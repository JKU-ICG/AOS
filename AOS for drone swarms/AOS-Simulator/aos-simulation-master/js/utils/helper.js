...
const canvasImage1 = (canvas) => {
    var newCanvas = document.createElement('canvas');
    newCanvas.width = 1005;
    newCanvas.height = 1005; //1005
    var newContext = newCanvas.getContext('2d');
    newContext.drawImage(canvas, 460, 350, 1005, 1005, 0, 0, 1005, 1005);  //460,350,1005,1005,1005,1005
    
    
 
    const dataUrl1 = newCanvas.toDataURL('cropped_image/png');
    return dataUrl1.substr(dataUrl1.indexOf(',') + 1);
};
